 ...
 */
export const updateEconomy = (s: any, dt: number) => {
 ...
 */
export const updateCooldowns = (s: any, dt: number, a: GameAudio) => {
 ...
 */
export const spawnEnemies = (s: any, dt: number, stage: StageConfig) => {
 ...
 */
export const processUnitsAndCombat = (s: any, dt: number, a: GameAudio, stage: StageConfig, timestamp: number) => {
